...
async def yt_search(ANUM):
    try:
        ANUM = urllib.parse.quote(ANUM)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={ANUM}"
        )
...
"""
async def yt_data(ANUM):
    params = {"format": "json", "url": ANUM}
