...
@Anime.on(events.NewMessage(outgoing=None, pattern=r"^.الحماية تفعيل$"))
...
@Anime.on(events.NewMessage(outgoing=None, pattern=r"^.الحماية اطفاء$"))
...
@Anime.on(events.NewMessage(outgoing=None, pattern=r"^.استثناء$"))
...
@Anime.on(events.NewMessage(outgoing=None, pattern=r"^.ازالة_استثناء$"))
