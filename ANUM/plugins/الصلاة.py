#ترجمه فريق الانمي على التيلكرام
import json

import requests
#ترجمه فريق الانمي على التيلكرام
from ..sql_helper.globals import gvarstatus
from . import Anime, edit_delete, edit_or_reply
...
async def get_adzan(adzan):
    ...
    Animeresult = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, Animeresult, "html")

# Copyright (C) 2021 ANUM TEAM
# FILES WRITTEN BY  @s_6_G