...
import requests
import json
from ANUM.helpers.functions.functions import translate
...
@Anime.ar_cmd(pattern="(الترجمة الفورية|الترجمه الفوريه|ايقاف الترجمة|ايقاف الترجمه)")
...
@Anime.ar_cmd(pattern="لغة الترجمة")
