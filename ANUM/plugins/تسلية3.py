...
from . import Anime, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m ANUM`",
        "**State changed from starting to up**",
        "__INFO:ANUM:Logged in as 557667062__",
        "__INFO:ANUM:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
