...
from Anime.razan._islam import *
...
@Anime.on(events.NewMessage(pattern=r"^.اختصر (.+) (.+)"))
...
@Anime.on(events.NewMessage(pattern=r"^\.(.+)"))
...
@Anime.on(events.NewMessage(pattern=r"^.قائمه الاختصار|قائمة الاختصار"))
...
@Anime.on(events.NewMessage(pattern=r"^\.امسح (.+)$"))
