...
@Anime.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular ANUM",
    },
)
...
@Anime.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}مودي <نص>",
        "examples": "{tr}مودي الانمي الاصلي",
    },
)
async def nekobot(cat):
...
@Anime.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular ANUM",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@Anime.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna ANUM is One of the Popular ANUM",
    },
)
async def nekobot(cat):
...
@Anime.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; ANUM is One of the Popular ANUM",
    },
)
async def nekobot(cat):
