...
from . import Alosma, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m PASH`",
        "**State changed from starting to up**",
        "__INFO:PASH:Logged in as 557667062__",
        "__INFO:PASH:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
