...
@Alosma.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular PASH",
    },
)
...
@Alosma.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}مودي <نص>",
        "examples": "{tr}مودي الفينوس الاصلي",
    },
)
async def nekobot(cat):
...
@Alosma.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular PASH",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@Alosma.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna PASH is One of the Popular PASH",
    },
)
async def nekobot(cat):
...
@Alosma.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; PASH is One of the Popular PASH",
    },
)
async def nekobot(cat):
