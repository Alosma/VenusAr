#ترجمه فريق الفينوس على التيلكرام
import json

import requests
#ترجمه فريق الفينوس على التيلكرام
from ..sql_helper.globals import gvarstatus
from . import Alosma, edit_delete, edit_or_reply
...
async def get_adzan(adzan):
    ...
    Alosmaresult = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, Alosmaresult, "html")
