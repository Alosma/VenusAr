...
import requests
import json
from PASH.helpers.functions.functions import translate
...
@Alosma.ar_cmd(pattern="(الترجمة الفورية|الترجمه الفوريه|ايقاف الترجمة|ايقاف الترجمه)")
...
@Alosma.ar_cmd(pattern="لغة الترجمة")
