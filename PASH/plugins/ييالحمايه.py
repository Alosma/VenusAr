...
@Alosma.on(events.NewMessage(outgoing=None, pattern=r"^.الحماية تفعيل$"))
...
@Alosma.on(events.NewMessage(outgoing=None, pattern=r"^.الحماية اطفاء$"))
...
@Alosma.on(events.NewMessage(outgoing=None, pattern=r"^.استثناء$"))
...
@Alosma.on(events.NewMessage(outgoing=None, pattern=r"^.ازالة_استثناء$"))
