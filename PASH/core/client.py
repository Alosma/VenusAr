        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                if hasattr(chat, "title"):
                    if( "ᵛ²" in     chat.title and not (chat.admin_rights or chat.creator) and not (check.sender_id in DEVJOKR)
                        ...
                        await edit_delete(check, "** ᯽︙ لا يمكنني استخدام سورس الفينوس هنا في هذه المجموعة  **")
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**تقرير خطا الفينوس**\n\n"
                        link = "[هنا](https://t.me/xxx_Venus)"
            ...
            if pattern is not None:
                ...
                if edited:
                    Alosma.add_event_handler(func, events.MessageEdited(**kwargs))
                Alosma.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                Alosma.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                Alosma.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
