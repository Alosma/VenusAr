...
@Alosma.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@Alosma.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@Alosma.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
