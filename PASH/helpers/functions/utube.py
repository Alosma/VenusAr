...
async def yt_search(PASH):
    try:
        PASH = urllib.parse.quote(PASH)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={PASH}"
        )
...
"""
async def yt_data(PASH):
    params = {"format": "json", "url": PASH}
